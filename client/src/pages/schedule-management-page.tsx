      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white p-4 rounded-lg shadow">
          ...
          <Calendar
            ...
            components={{
              Day: ({ day, date, disabled, selected }) => {
                const hasSchedule = !disabled && hasScheduleOnDate(date);
                return (
                  <button
                    className={cn(
                      "relative h-9 w-9 p-0 font-normal",
                      !disabled && "aria-selected:opacity-100",
                    ...
                    style={{
                      marginBottom: hasSchedule ? "8px" : "0"
                    }}
                    disabled={disabled}
                  >
                    <time dateTime={format(date, "yyyy-MM-dd")}>{day}</time>
                    {hasSchedule && (
