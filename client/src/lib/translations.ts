...
export const translations: TranslationMap = {
  ko: {
    common: {
      ...
      medications: '투약 정보',
      vitalSigns: '생체 신호',
      recentVitalSigns: '최근 생체 신호',
      date: '날짜',
      bloodPressure: '혈압',
      heartRate: '심박수',
      temperature: '체온',
      respRate: '호흡수',
      currentMedications: '현재 투약 중인 약물',
      dosage: '용량',
      frequency: '빈도',
      timing: '투약 시간',
      fallRiskDesc: '환자의 낙상 위험 분석 정보',
      riskLevel: '위험 수준',
      riskScore: '위험 점수',
      fallHistory: '낙상 이력',
      noFallHistory: '낙상 이력이 없습니다',
    },
    dashboard: {
      title: '대시보드',
  ...
  en: {
    common: {
      ...
      recentVitalSigns: 'Recent Vital Signs',
      date: 'Date',
      ...
      frequency: 'Frequency',
      timing: 'Timing',
      fallRiskDesc: 'Fall risk assessment information',
      riskLevel: 'Risk Level',
      riskScore: 'Risk Score',
      fallHistory: 'Fall History',
      noFallHistory: 'No fall history',
    },
    dashboard: {
      title: 'Dashboard',
